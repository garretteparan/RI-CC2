#ifndef LIBGMBPT_RI_EOMIP_ENERGY_R_H
#define LIBGMBPT_RI_EOMIP_ENERGY_R_H
...
/** \brief Evaluates the EOMIP energy
 
    \ingroup libgmbpt_eomip
 **/
template<typename TC, typename TI>
class ri_eomip_energy_r {
private:
...
public:
    ...
    /** \brief Constructor of eomip_energy_r
        \param[in] dev dev
...
#endif // LIBGMBPT_RI_EOMIP_ENERGY_R_H
