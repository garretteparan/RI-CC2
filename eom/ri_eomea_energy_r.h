#ifndef LIBGMBPT_RI_EOMEA_ENERGY_R_H
#define LIBGMBPT_RI_EOMEA_ENERGY_R_H
...
/** \brief Evaluates the EOMEA energy
 
    \ingroup libgmbpt_eomea
 **/
template<typename TC, typename TI>
class ri_eomea_energy_r {
private:
...
public:
    ...
    void perform(
        ...
        Mat<TC> &t1a, Col<TC> &r1,
        double &ene_exci, arma::vec Ea, 
        double c_os, double c_ss, 
        Col<TC> &sigma, unsigned algo);
...
#endif // LIBGMBPT_RI_EOMEA_ENERGY_R_H
