#ifndef LIBGMBPT_RI_EOMIP_UNR_ENERGY_R_H
#define LIBGMBPT_RI_EOMIP_UNR_ENERGY_R_H
...
/** \brief Evaluates the EOMIP unrestricted energy
 
    \ingroup libgmbpt_eomip
 **/
template<typename TC, typename TI>
class ri_eomip_unr_energy_r {
private:
...
#endif // LIBGMBPT_RI_EOMIP_UNR_ENERGY_R_H
