#ifndef LIBGMBPT_RI_EOMEE_ENERGY_R_H
#define LIBGMBPT_RI_EOMEE_ENERGY_R_H
...
public:
    ...
    ri_eomee_energy_r(
        ...
        m_dev(dev), m_reg(m_reg0), m_b1(b1), m_b3(b3), m_b4(b4),
...
#endif // LIBGMBPT_RI_EOMEE_ENERGY_R_H
